...
//   // في حالة عدم وجود توكن، نقوم بعرض رسالة تحذيرية
//   if (!token) {
//     return (
...
// import AlertTitle from "@mui/material/AlertTitle";
// import Stack from "@mui/material/Stack";
// import { MdEventNote } from "react-icons/md"; // استيراد الأيقونة
...
//       });
//     } catch (err) {
//       console.error("Error Response:", err.response);  // طباعة الاستجابة بالكامل
//       setAlertType("error");
//       setResponseMessage(
//         err.response?.data?.detail || "Failed to create the judge. Please try again."
//       );
...
//           className="flex items-center bg-cyan-500 hover:bg-cyan-700 text-white font-bold py-3 px-6 rounded-full transition-all duration-200"
//         >
//           <MdEventNote className="mr-2 text-2xl" /> {/* الأيقونة */}
//           Create Judge
//         </button>
//       )}
