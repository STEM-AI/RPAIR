      ...
      <div className="flex items-center space-x-3">
        <NavLink to={"/"}>
          <img
            src={
              location.pathname === "/" ||
              location.pathname === "/competitions/ComingSoon"
                ? isScrolled
                  ? logoBlack
                  : logo
                : logoBlack
      ...
      >
        ...
        <div className="relative group w-full" ref={challengesDropdownRef}>
          ...
          {dropdowns.challenges && (
            <ul
              className={`absolute z-50 left-0 mt-2 w-48 bg-white shadow-lg rounded-lg transform scale-95 transition-transform duration-300 ease-out origin-top`}
            >
              {[
