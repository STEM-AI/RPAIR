...
//    useEffect(() => {
//     driverSocketRef.current = new WebSocket(`ws://147.93.56.71:8001/ws/competition_event/${eventName}/driver_iq/`);
...
//         <DriverRounds matches={driverMatches} />
//         <AutoRounds matches={autoMatches} />
//       </div>
...
// import axios from "axios";
// import { Helmet } from "react-helmet-async";
// import DriverRounds from "./LiveVexIQ/LiveSkillsIQ/DriverRounds";
// import AutoRounds from "./LiveVexIQ/LiveSkillsIQ/AutoRounds";
...
//          <DriverRounds eventName={eventName} token={token} />
//         <AutoRounds eventName={eventName} token={token} />
...
//   useEffect(() => {
//     const storedAutoMatches = JSON.parse(localStorage.getItem("autoMatches")) || [];
//     const storedDriverMatches = JSON.parse(localStorage.getItem("driverMatches")) || [];
//     setAutoMatches(storedAutoMatches);
//     setDriverMatches(storedDriverMatches);
//   }, []);

//   // WebSocket for Auto Matches
//   useEffect(() => {
//     autoSocketRef.current = new WebSocket(`${process.env.REACT_APP_WS_URL}/ws/competition_event/${eventName}/auto/`);
...
//       if (data.game_id && data.score?.autonomous !== undefined) {
//         setAutoMatches(prev => {
//           const updatedMatches = updateMatches(prev, data, 1);
//           localStorage.setItem("autoMatches", JSON.stringify(updatedMatches));
...
//           const updatedMatches = updateMatches(prev, data, 1);
//           localStorage.setItem("driverMatches", JSON.stringify(updatedMatches));
//           return updatedMatches;
//         });
//         setLastUpdate(new Date());
//       }
...
//     setAutoMatches(storedAutoMatches);
//     setDriverMatches(storedDriverMatches);
//     updateTeamRounds(storedAutoMatches, storedDriverMatches);
//   }, []);

//   // Update team rounds when matches change
//   useEffect(() => {
//     updateTeamRounds(autoMatches, driverMatches);
//   }, [autoMatches, driverMatches]);

//   const updateTeamRounds = (autoMatches, driverMatches) => {
//     const rounds = {};
