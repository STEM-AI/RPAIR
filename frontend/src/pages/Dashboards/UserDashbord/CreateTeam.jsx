  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (errorMessages.length === 0) {
        errorMessages.push(
          `Failed to create team. Please check your inputs and try again.${err.response.data}`,
        );
      } else {
        errorMessages.push(
    ...
    <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="grid gap-4">
            ...
            {isManualOrgEntry ? (
              <div className="flex items-center mb-4">
                <input
                  ...
                  onChange={(e) =>
                    handleChange(e, "organization_info", null, "name")
                  }
          ...
          <div className="md:flex md:justify-between">
            <div className="md:mr-2">
              ...
              {isManualOrgEntry ? (
                <input
                  ...
                  onChange={(e) =>
                    handleChange(e, "organization_info", null, "id")
                  }
                  className="bg-gray-100 border rounded py-2 px-4 w-full"
                  required
                />
            ...
            <div className="md:mr-2">
              ...
              <select
                ...
                onChange={(e) =>
                  handleChange(e, "organization_info", null, "type")
                }
                className={`border rounded py-2 px-4 w-full ${isManualOrgEntry ? "bg-gray-100" : "bg-gray-200 cursor-not-allowed"}`}
            ...
            <div key={index} className="flex items-center gap-4">
              ...
              {isManualOrgEntry && (
                <button
                  type="button"
                  onClick={() =>
                    handleRemoveItem("organization_info", index, "contacts")
                  }
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-5">
          ...
          formData.competition === "flutter" ||
          formData.competition === "arduino" ? (
            ""
          ) : (
            <div className="w-full md:w-1/2">
              <label className="block mb-2 text-sm font-bold text-gray-700">
              ...
              <div className="w-full md:w-1/2">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setFormData({
                      ...formData,
                      team_leader_phone_number: value,
                    });
                  }}
                  className="bg-gray-200 border rounded py-2 px-4 w-full"
                  required
                ...
                <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mt-4">
                  ...
                  <div className="w-full md:w-1/2">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleChange(e, "coach", index, "position")
                      }
                      className="bg-gray-200 border rounded py-2 px-4 w-full"
                      required={showCoachForm}
                    >
