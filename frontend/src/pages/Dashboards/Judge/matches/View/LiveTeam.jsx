...
//   useEffect(() => {
//     const fetchData = () => {
//       // Read match results from teamwork.jsx storage
//       const storedMatches = JSON.parse(localStorage.getItem("teamworkMatches")) || {};
//       const storedTeams = JSON.parse(localStorage.getItem("teamworkRankings")) || [];
      
//       setMatches(Object.entries(storedMatches).map(([matchCode, data]) => ({
//         matchCode,
//         ...data
//       })));
