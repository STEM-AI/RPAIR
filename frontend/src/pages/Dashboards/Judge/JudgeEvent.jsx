  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col sm:flex-row justify-between items-center mb-10 gap-4">
        <h2 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-800 to-blue-600">
          Your Events
        </h2>
        <button
          onClick={handleRetry}
          className="flex items-center px-4 py-2 bg-white border border-blue-600 text-blue-600 hover:bg-blue-50 
            font-medium rounded-lg transition-all duration-200 shadow-sm"
        >
          <MdRefresh className="h-5 w-5 mr-2" />
          Refresh List
        </button>
...
//   const token = localStorage.getItem("access_token");
//   const groupEventsByCompetition = (events) => {
//   return events.reduce((grouped, event) => {
//     const key = event.competition_event.competition_name;
//     if (!grouped[key]) {
//       grouped[key] = [];
//     }
...
//     {Object.entries(groupEventsByCompetition(events)).map(([competitionName, competitionEvents]) => (
//       <div key={competitionName} className="space-y-6">
//         <h3 className="text-2xl font-bold text-gray-900 border-l-4 border-cyan-600 pl-4">
//           {competitionName}
//         </h3>
//         <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
