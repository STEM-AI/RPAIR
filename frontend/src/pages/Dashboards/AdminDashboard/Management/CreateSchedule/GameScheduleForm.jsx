...
//   if (competitionOptions.value === "vex_iq") {
//     const stagesOptions = [
//       "driver_iq",
//       "teamwork",
//       "auto"
//     ];
//   }else if (competitionOptions.value === "vex_go") {
//     const stagesOptions = [
//       "driver_go",
//       "coop",
//       "coding",
//     ];
//   }else if (competitionOptions.value === "vex_123") {
//     const stagesOptions = [
//       "vex_123",
//     ];
//   } else if (competitionOptions.value === "programming") {
//     const stagesOptions = [
//       "python",
//     ];
