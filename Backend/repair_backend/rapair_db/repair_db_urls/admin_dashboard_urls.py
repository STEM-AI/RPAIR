...
urlpatterns = [
    ...
    path('team/<int:id>/', TeamRetrieveDestroyView.as_view(), name='delete-team'),  # Delete team API  # TODO: Add validation and permissions for deleting team.   # TODO: Add notification and email functionality for judges.   # TODO: Add leaderboard functionality.   # TODO: Add team registration functionality.   # TODO: Add team submission functionality.   # TODO: Add
    ...
    path('<int:competition_event>/judge-event/', JudgeForCompetitionEventCreateView.as_view(), name='judge-event'),  # Judge event API  # TODO: Add validation and permissions for judging event.   # TODO: Add notification and email functionality for judges.   # TODO: Add leaderboard functionality.   # TODO: Add team registration functionality.   # TODO: Add team submission functionality.   # TODO: Add  # TODO: Add  # TODO: Add  # TODO:
