...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'repair_backend.rapair_db.validators.StrongPasswordValidator',
    },
]
...
# Celery settings
CELERY_BROKER_URL = config('CELERY_BROKER_HOST_URL','redis://localhost:6379/0')  # Redis URL
CELERY_RESULT_BACKEND = config('CELERY_RESULT_BACKEND_HOST_URL','redis://localhost:6379/0')  # Redis URL
