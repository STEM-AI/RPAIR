...
#         if team.competition_event.filter(competition_event=event).count() == 0:
...
#             team.competition_event.filter(competition_event=event).update(eng_notebook_score=scores['eng_notebook_score'])
#         if scores['interview_score'] :
#             team.competition_event.filter(competition_event=event).update(interview_score=scores['interview_score'])
#         if scores['inspect_score'] :
#             team.competition_event.filter(competition_event=event).update(inspect_score=scores['inspect_score'])
